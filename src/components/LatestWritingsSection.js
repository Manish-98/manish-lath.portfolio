...
function PostCard({ post }) {
  return (
    <article className="card flex flex-col gap-4">
        ...
        {/* Post Content */}
        <p className="text-secondary leading-relaxed text-left sm:text-justify">
          {post.description}
        </p>
      ...
      <div className="flex items-center justify-between">
        ...
        {/* Read More Button */}
        <button className="inline-flex items-center gap-2 text-accent hover:text-accent-hover transform translate-x-2 group-hover:translate-x-0 transition-all duration-200">
